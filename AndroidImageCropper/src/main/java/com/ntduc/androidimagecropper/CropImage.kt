...
import com.ntduc.androidimagecropper.CropImageView.RequestSizeOptions
import android.graphics.Rect
import androidx.annotation.DrawableRes
import com.ntduc.androidimagecropper.CropImageView.CropResult
 ...
 * question](http://stackoverflow.com/questions/32789027/android-m-camera-intent-permission-bug).
    ...
    open class ActivityResult : CropResult, Parcelable {
        ...
        companion object {
            @JvmField
            val CREATOR: Creator<ActivityResult?> = object : Creator<ActivityResult?> {
